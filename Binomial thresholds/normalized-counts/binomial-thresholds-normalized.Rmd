...
# Remove blacklist genes before normalization
filtered_genes <- rownames(counts.gene)[!(rownames(counts.gene) %in% blacklist_allRibo[,1])]
counts.gene.filtered <- counts.gene[filtered_genes, ]
counts.gene_annotations.filtered <- counts.gene_annotations[counts.gene_annotations$geneID %in% filtered_genes, ]

# Calculate TPM on the filtered dataset
gene.tpm <- tpm(counts.gene.filtered, counts.gene_annotations.filtered$gene_length)
gene.tpm <- data.frame(gene.tpm)
...
sampledata$TPM_nRibo <- colSums(geneTPM.nRibo)
sampledata$TPM_mtRibo <- colSums(geneTPM.mtRibo)
sampledata$TPM_allRibo <- colSums(geneTPM.allRibo)
...
write.xlsx(res.TB_C, file = paste0("results-all-genes/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-all-genes/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-all-genes/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-all-genes/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-all-genes/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
keep_genes_TPM <- rowMeans(gene.tpm) > tpm_filter_threshold

cat("Number of genes BEFORE TPM filtering:", nrow(gene.tpm), "\n")
cat("Number of genes with mean TPM <", tpm_filter_threshold, ":", sum(!keep_genes_TPM), "\n")

gene.tpm.filtered <- gene.tpm[keep_genes_TPM, ]

txi.filtered <- txi.toGene
txi.filtered$counts    <- txi.toGene$counts[keep_genes_TPM, ]
txi.filtered$abundance <- txi.toGene$abundance[keep_genes_TPM, ]
txi.filtered$length    <- txi.toGene$length[keep_genes_TPM, ]

cat("Number of genes AFTER TPM filtering:", nrow(gene.tpm.filtered), "\n")
...
write.xlsx(res.TB_C, file = paste0("results-filter0.001/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.001/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.001/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.001/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.001/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.005/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.005/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.005/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.005/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.005/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.01/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.01/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.01/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.01/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.01/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.02/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.02/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.02/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.02/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.02/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.05/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.05/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.05/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.05/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.05/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.1/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.1/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.1/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.1/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.1/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C, file = paste0("results-filter0.5/res_TB_vs_C_", dea_formula, "_all.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)

# Significant
res.TB_C.sig <- subset(res.TB_C, ((padj < cutoff_alpha) & !is.na(padj)))

write.xlsx(res.TB_C.sig, file = paste0("results-filter0.5/res_TB_vs_C_", dea_formula, "_padj<0.25.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
write.xlsx(res.TB_C.det, file = paste0("results-filter0.5/res_TB_vs_C_", dea_formula, "padj<0.25_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.05, ], file = paste0("results-filter0.5/res_TB_vs_C_", dea_formula, "padj<0.05_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
write.xlsx(res.TB_C.det[res.TB_C.det$padj < 0.01, ], file = paste0("results-filter0.5/res_TB_vs_C_", dea_formula, "padj<0.01_detectable.xlsx"),
           colNames = TRUE, rowNames = FALSE, append = FALSE, overwrite = TRUE)
...
```{r}
binomial <- read.xlsx("./binomal_comparisons-normalized.xlsx")
binomial
```
...
binomial_tidy <- binomial %>% 
  ...
  filter(!situation %in% c(#"prefilter genes <10 counts",
                         #"prefilter genes <20 counts",
                         "prefilter genes <50 counts",
                         "prefilter genes <100 counts"))
...
ggsave("./binomial_plot-normalized.png")
```
