...
```{r}
confounding_var <- colnames(sampledata)[c(3:4, 6:20)]
confounding_name <- c("Group", "Latent TB", "Age", "Age", "Heart Rate (BPM)", "Heart Rate (BPM)",
                      "Weight", "Weight", "Height", "Height", "BMI", "Waist size",
                      "Hip size", "Appetite", "Depression", "RIN", "RIN")
...
for (i in seq_along(confounding_var)) {
  ...
  ggsave(filename = paste0("plots/dim_reduction/PCA/PCA12_", confounding_var[i], ".jpg"),
